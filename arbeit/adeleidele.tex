...
\subsection{Die Gruppe der Idele}
		...
		Wir haben schon mehrmals die lokalen Betr"age auf dem eigneschr"ankten direkten Produkt betrachtet. 
		...
		\begin{satz}[Artins Produktformel]\label{satz:adeleidele:artin}
		...
		%Zum Schluss m"ochten wir auch auf den Idelen die Integration der einfachen Funktionen $f = \prod_{p\leq\infty} f_p$ mit $f_p=\ind_\Zp$ fast überall betrachten.
	%\begin{satz}\label{satz:adeleidele:intI}
		%Sei $f: \A \to \Komplex$ eine einfache integrierbare Funktion auf den Idelen. 
		%Es gilt die Produktformel
		%\begin{align*}
