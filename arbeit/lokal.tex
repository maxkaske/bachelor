...
%fourierumkehrformel: done
		...
		Die Standardcharaktere induzieren gewissermaßen einen Isomorphismus zwischen der additiven Gruppe $\Kpp$ und deren Dualgruppe $\widehat{\Kpp}$. 
...
%FILLER
	...
	\begin{defi}%%%TODO SCHOENER DEFINIEREN
