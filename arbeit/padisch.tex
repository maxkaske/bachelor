...
\subsection{Absolutbeträge}
	...
	Betrachten wir nun den K"orper $\mathbb{K} = \Q$ der rationalen Zahlen und sei $x\in \Q^\times = \Q\setminus\{0\}$ eine beliebige rationale Zahl ungleich $0$. 
	Dann existiert eine bis auf Reihenfolge eindeutige Primfaktorzerlegung
	\begin{align*}
		x = \prod_{p} p^{v_p},
	\end{align*}
	...
	\end{defi}
	Der Name soll auch Programm sein. Wir zeigen also:
	\begin{lemma}
...
\subsection{Vervollständigungen von \texorpdfstring{$\K$}{Q}}
	...
	\begin{proof}[Beweisidee]
		Die Grundidee der Konstruktion ist mit der Menge aller Cauchy-Folgen in $\K$ zu beginnen.
		Diese wird zu einem Ring wenn wir Addition und Multiplikation gliedweise definieren.
		Anschließen teilen wir alle Nullfolgen raus, d.h. zwei Cauchy-Folgen sind genau dann "aquivalent, wenn sie sich um eine Nullfolge unterscheiden.
		Zu guter letzt l"asst sich $\K$ einbetten als die Menge aller konstanten Folgen.
